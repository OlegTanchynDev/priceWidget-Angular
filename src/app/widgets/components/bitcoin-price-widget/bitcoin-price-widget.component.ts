...
@Component({
  selector: 'app-bitcoin-price-widget',
  templateUrl: './bitcoin-price-widget.component.html',
  styleUrls: ['./bitcoin-price-widget.component.css']
})
export class BitcoinPriceWidgetComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit() {
    ...
    /** Customize widget */
    this.style = styles.find(o => o.widgetName === 'bitcoin-price-widget');
    ...
    this.history = historyBitcoinPriceWidget;
    this.getDetails();
  }
